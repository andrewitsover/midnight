...
export function round<T extends NumericParam>(value: T, places?: NumericParam): ToDbType<T>;
export function rtrim<T extends StringParam>(value: T, remove?: StringParam): ToDbType<T>;
...
export function not(value: QueryCompareTypes | QueryCompareTypes[]): DbBoolean;
export function gt(value: NonNullable<QueryCompareTypes>): DbBoolean;
export function gte(value: NonNullable<QueryCompareTypes>): DbBoolean;
export function lt(value: NonNullable<QueryCompareTypes>): DbBoolean;
export function lte(value: NonNullable<QueryCompareTypes>): DbBoolean;
export function like(pattern: string | AnyStringType | RegExp): DbBoolean;
export function match(pattern: string | AnyStringType): DbBoolean;
export function glob(pattern: string | AnyStringType): DbBoolean;
export function eq(value: QueryCompareTypes): DbBoolean;
